...
// Monochromatic thin-stroke SVG icons
const IconRange = (
        ...
        <>
            <ComingSoonBanner
                ...
                features={[
                    ...
                    { title: "Camera", description: "30x Zoom", icon: IconCamera },
                    { title: "Peripherals", description: "LRF & Thermal integrated", icon: IconPeripherals },
                ]}
            />
            <Newsletter />
        </>
